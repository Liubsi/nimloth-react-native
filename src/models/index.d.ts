...
export declare class AllCoins {
  ...
  static copyOf(source: AllCoins, mutator: (draft: MutableModel<AllCoins, AllCoinsMetaData>) => MutableModel<AllCoins, AllCoinsMetaData> | void): AllCoins;
}
...
export declare class CoinData {
  ...
  static copyOf(source: CoinData, mutator: (draft: MutableModel<CoinData, CoinDataMetaData>) => MutableModel<CoinData, CoinDataMetaData> | void): CoinData;
}
